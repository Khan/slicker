...
class FixUsesTest(base.TestBase):
    ...
    @unittest.skip("We don't yet support this (see #7).  (Although what we "
                   "do isn't strictly wrong, just less than ideal.")
...
class FixMovedRegionSuggestorTest(base.TestBase):
    ...
    @unittest.skip("We don't handle this case yet (see #7).")
